...
# K=10, pip + barycenter better than impSeq and all other methods


dda_pip <- mspip("/stornext/General/data/academic/lab_davis/prot/benchmarking/PXD002370/Ratio2.5_txt/txt", 
...
dda_pip2 <- mspip("/stornext/General/data/academic/lab_davis/prot/benchmarking/PXD002370/Ratio2.5_txt/txt", 
                  k=3, 
                  thresh = 0.0,
...
pcv <- plotCV2(y_msImpute, main = "rank2", ylim = c(0, 0.065))
...
p1 <- ggplot(fullTables2, aes(y=TP, x=FP, color=method, group = method)) +
  ...
  labs(title = "PXD002370-Ratio 2.5") + xlab("False Positives") + ylab("True Positives")
